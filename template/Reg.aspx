                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtName" runat="server" required placeholder="Full Name" class="form-control input-md"></asp:TextBox>
                                                </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtNumber" runat="server" required placeholder="Mobile" Class="form-control input-md"></asp:TextBox>
                                                </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtEmail" runat="server" required placeholder="Email" Class="form-control input-md"></asp:TextBox>
                                                </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    <label class="sr-only control-label" for="phone">Salary<span class=" "> </span></label>
                                                    <asp:TextBox ID="txtSalary" runat="server" required placeholder="Salary" Class="form-control input-md"></asp:TextBox>
                                                </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtCity" runat="server" required placeholder="City" Class="form-control input-md"></asp:TextBox>
                                                </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtCompany" runat="server" required placeholder="Company" Class="form-control input-md"></asp:TextBox>
                                                </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="ddlProducts" OnSelectedIndexChanged="ddlProducts_SelectedIndexChanged" runat="server" required placeholder="Email" Class="form-control input-md">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    <label class="sr-only control-label" for="phone">Phone<span class=" "> </span></label>
                                                    <asp:DropDownList ID="ddlBanks" runat="server" required placeholder="Email" Class="form-control input-md">
                                                        <asp:ListItem Value="0">-- Select Bank --</asp:ListItem>
                                                        <asp:ListItem Value="1">Any Bank</asp:ListItem>
                                                        <asp:ListItem Value="1">SBI</asp:ListItem>
                                                        <asp:ListItem Value="1">HDFC</asp:ListItem>
                                                        <asp:ListItem Value="1">INDUSIND</asp:ListItem>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    <label class="sr-only control-label" for="phone">Phone<span class=" "> </span></label>
                                                    <asp:DropDownList ID="ddlLoanType" runat="server" required placeholder="Email" Class="form-control input-md">
                                                        <asp:ListItem Value="0">-- Select Loan --</asp:ListItem>
                                                        <asp:ListItem Value="1">Personal Loan</asp:ListItem>
                                                        <asp:ListItem Value="1">Home Loan</asp:ListItem>
                                                        <asp:ListItem Value="1">Loan Against Property</asp:ListItem>
                                                        <asp:ListItem Value="1">Car Loan</asp:ListItem>
